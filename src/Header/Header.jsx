        ...
        <header className="header">
            <div className="container">
                ...
                <div className="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <li className="nav-item"><Link className="nav-link" to="">Browse Projects</Link></li>
                    <li className="nav-item mbl-nav"><Link className="nav-link" to="">Login</Link></li>
                    <li className="nav-item mbl-nav"><Link className="nav-link" to="/register">Register</Link></li>
                    </ul>
                </div>
                </nav>
                <Link className="logo" to="/"><img src={logo} alt="" /></Link>
                <div className="rt-btn"> <Link to="" className="get-start-btn">Login</Link> <Link to='/register' className="get-start-btn">Register</Link> </div>
            </div>
        </header>
    );
